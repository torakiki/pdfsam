 ...
 *
 */
public class PreferenceCheckBoxTest extends ApplicationTest {
    ...
    public void start(Stage stage) {
        Scene scene = new Scene(
                new HBox(new PreferenceCheckBox(BooleanUserPreference.CHECK_UPDATES, "select", false, userContext)));
