...
public class ModuleServiceConfig {
    ...
    DefaultEntityRepository<ModuleUsage> usageRepository(ObjectMapper mapper) {
        return new DefaultEntityRepository<>("/org/pdfsam/modules/usage", mapper, ModuleUsage.class);
    }
}
