...
public class OpenUrlRequestTest {
    ...
    @Test
    public void nullArg() {
        assertThrows(IllegalArgumentException.class, () -> new NativeOpenUrlRequest(null));
    }
    ...
    public void notNullArg() {
        NativeOpenUrlRequest victim = new NativeOpenUrlRequest("ChuckNorris");
        assertEquals("ChuckNorris", victim.url());
    }
}
