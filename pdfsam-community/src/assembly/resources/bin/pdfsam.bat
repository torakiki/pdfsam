...
%JAVACMD% %JAVA_OPTS% -Xmx256M -classpath %CLASSPATH% -Dapp.name="pdfsam-basic" -splash:"%BASEDIR%"\resources\splash.gif -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.pdfsam.community.App %CMD_LINE_ARGS%
