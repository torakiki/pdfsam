 ...
 */
public record PremiumModule(int id, String name, String description, String url, PremiumProduct product) {

    public PremiumModule(int id, String name, String description, String url, String product) {
