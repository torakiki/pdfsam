...
class DashboardItemPane extends BorderPane {
    ...
    DashboardItemPane(DashboardItem item) {
        ...
        setCenter(scroll);
        eventStudio().add(SetActiveToolRequest.class, enableFooterListener, Integer.MAX_VALUE, ReferenceStrength.STRONG);
    }

    private void unregister() {
        eventStudio().remove(SetActiveToolRequest.class, enableFooterListener);
    }
    ...
    private HBox buildFooter() {
        ...
        closeButton.setOnAction(e -> eventStudio().broadcast(SetActiveToolRequest.CURRENT_TOOL));
