...
public class LongColumnTest {
    ...
    public void negativePages() {
        assertThat(LongColumn.PAGES.getTextValue(-1), isEmptyString());
    }

    @Test
    public void pages() {
        assertEquals("10", LongColumn.PAGES.getTextValue(10));
    }
    ...
    public void getPagesObservableValue() {
        ...
        SelectionTableRowData data = new SelectionTableRowData(file);
        data.setPages(10);
        assertEquals(10, LongColumn.PAGES.getObservableValue(data).getValue());
    }
