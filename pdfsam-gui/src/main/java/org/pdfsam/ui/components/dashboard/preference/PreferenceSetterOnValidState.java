...
class PreferenceSetterOnValidState implements ChangeListener<FXValidationSupport.ValidationState> {
    ...
    @Override
    public void changed(ObservableValue<? extends FXValidationSupport.ValidationState> observable, FXValidationSupport.ValidationState oldValue,
            FXValidationSupport.ValidationState newValue) {
