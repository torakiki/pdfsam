...
public class PreferenceCheckBoxTest {
    ...
    public void start(Stage stage) {
        ...
        Scene scene = new Scene(
                new HBox(new PreferenceCheckBox(BooleanPersistentProperty.CHECK_UPDATES, "select", false, appContext)));
    ...
    public void preferenceSetOnClick() {
        ...
        verify(persistentSettings).set(eq(BooleanPersistentProperty.CHECK_UPDATES), eq(Boolean.TRUE));
    }
}
