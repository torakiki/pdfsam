...
public class PreferenceBrowsableFileFieldTest {
    ...
    public void start(Stage stage) {
        PreferenceBrowsableFileField victim = new PreferenceBrowsableFileField(StringPersistentProperty.WORKING_PATH,
                FileType.PDF, OpenType.OPEN, appContext);
    ...
    public void validValue() throws Exception {
        ...
        verify(persistentSettings).set(StringPersistentProperty.WORKING_PATH, file.getAbsolutePath());
    }
