...
import static org.pdfsam.ConfigurableSystemProperty.LOCALE_PROP;
import static org.pdfsam.ConfigurableSystemProperty.THEME_PROP;
...
public enum StringPersistentProperty implements PersistentProperty<String> {
    ...
    THEME(() -> System.getProperty(THEME_PROP, "LIGHT"));
